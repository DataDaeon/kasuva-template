<?php
class Perfectus_Fltproducts_Block_Newproduct_Home_List extends Mage_Catalog_Block_Product_List
{
    ...
    protected function _getFltProductCollection()
    {
		...
		}else if(Mage::getStoreConfig('fltproducts/newproduct/max_product')){
			$products->setPageSize(Mage::getStoreConfig('fltproducts/newproduct/max_product'));
		}
